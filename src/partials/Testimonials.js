...
import Echohub from "../images/Echo-hub.svg";
import HR360 from "../images/HR360.svg";
import CommonGround from "../images/Common-ground.svg";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">{copy["partners"]}</h2>
            <p
              className="text-xl text-gray-600"
              data-aos="zoom-y-out"
            >
              {copy["partners-paragraph"]}
            </p>
          </div>
